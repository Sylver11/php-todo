...
<nav class="navbar"><p href="">Welcome <?php echo $_SESSION['username']?></p><form action="todo.php" method="POST">
    <input class="btn btn-secondary" type="submit" value="Logout" name="logout">
</form></nav>
<div style="height: 140px;"><img style="width: 100%; height:130px;"src="busy-pic.jpg" alt="busy"></div>
<div>
...
<form>
    ...
    <button class="button_2 btn btn-primary">Add</button> 
    </div>
...
function cleanUp(){
    $.ajax({
            ...
            success: function(data) {  
                $( ".inputId" ).html(data); 
                $("li").wrapInner("<p>").append("<button class=\"done btn btn-success\">Done</button><button class=\"del btn btn-danger\">Delete</button><button class=\"edit btn btn-warning\">Edit</button><br><br><div class=\"update\"><input class=\"update-item\" type=\"text\"><button class=\"update-button\">Update</button></div><br>");
                renderStrike();
            }
    })
}
